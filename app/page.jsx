        ...
        <section className="py-20">
          <div className="container px-4 mx-auto ">
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
              {featuresData.map((featuresData, idx) => (
                <Card key={idx} className="p-6" >
                  <CardContent className="space-y-4 pt-4 " >
                    {featuresData.icon}
                    <h3 className="text-xl font-semibold" >{featuresData.title}</h3>
                    <p className="text-gray-500 pb-4" >{featuresData.description}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
        ...
        <section className="py-20 bg-blue-600 ">
          <div className="container px-4 mx-auto text-center ">
            ...
            <Link href={"/dashboard"}>
              <Button
                size={"lg"}
                className="bg-white text-blue-600 hover:bg-blue-50 animate-bounce px-7 "
              >
                Start Free Trial
              </Button>
            </Link>
